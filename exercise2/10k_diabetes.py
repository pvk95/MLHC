...
category_map = {'race': {'AfricanAmerican': 0, 'Caucasian': 1, 'Asian': 2, 'Other': 3, 'Hispanic': 4, '?': np.NaN},
                ...
                'A1Cresult': {'None': np.NaN, '>8': 1, 'Norm': 2, '>7': 3},
...
train_y = train_df[pred_columns]
valid_y = valid_df[pred_columns]
test_y = test_df[pred_columns]
...
print(f'The score on the validation set was {score}')
